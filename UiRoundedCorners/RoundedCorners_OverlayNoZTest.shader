Shader "UI/RoundedCorners/RoundedCorners_OverlayNoZTest" {
    Properties {
    ...
    SubShader {
        Tags {
            ...
            "Queue"="Overlay"  // Mudei para Overlay para garantir que renderize acima de tudo
        }
        ...
        Cull Off
        Lighting Off
        ZTest Always  // Mantenha Always para garantir que a renderização ocorra acima de outros objetos
        ColorMask [_ColorMask]
        // ---
        
        Blend SrcAlpha OneMinusSrcAlpha, One OneMinusSrcAlpha
        ZWrite Off  // ZWrite deve ser Off para a transparência
